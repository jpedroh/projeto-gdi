...
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel I WHERE cod_escritura = '6646303088'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '75477832010'), (SELECT REF(C) FROM tb_contrato C WHERE numero = 8272), TO_DATE('01-09-2021', 'dd-mm-yyyy')));;INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel I WHERE cod_escritura = '3471019961'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '75477832010'), (SELECT REF(C) FROM tb_contrato C WHERE numero = 6526), TO_DATE('07-06-2021', 'dd-mm-yyyy')));
