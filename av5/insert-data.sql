...
---------------------------------------------------------------------------------------------------- INSERTS BONIFICAÇÃO ----------------------------------------------------------------------------------------------------
INSERT INTO tb_celebra VALUES (tp_celebra((SELECT REF (C) FROM tb_contrato C WHERE numero = 3543), (SELECT REF (F) FROM tb_funcionario F WHERE cpf = '37383978099'), (SELECT REF (B) FROM tb_bonificacao B WHERE id = 1)));
INSERT INTO tb_celebra VALUES (tp_celebra((SELECT REF (C) FROM tb_contrato C WHERE numero = 8272), (SELECT REF (F) FROM tb_funcionario F WHERE cpf = '41893520048'), (SELECT REF (B) FROM tb_bonificacao B WHERE id = 2)));
INSERT INTO tb_celebra VALUES (tp_celebra((SELECT REF (C) FROM tb_contrato C WHERE numero = 6526), (SELECT REF (F) FROM tb_funcionario F WHERE cpf = '23251067052'), (SELECT REF (B) FROM tb_bonificacao B WHERE id = 3)));
INSERT INTO tb_celebra VALUES (tp_celebra((SELECT REF (C) FROM tb_contrato C WHERE numero = 2393), (SELECT REF (F) FROM tb_funcionario F WHERE cpf = '51927985072'), (SELECT REF (B) FROM tb_bonificacao B WHERE id = 4)));
INSERT INTO tb_celebra VALUES (tp_celebra((SELECT REF (C) FROM tb_contrato C WHERE numero = 5121), (SELECT REF (F) FROM tb_funcionario F WHERE cpf = '89712208052'), (SELECT REF (B) FROM tb_bonificacao B WHERE id = 5)));
INSERT INTO tb_celebra VALUES (tp_celebra((SELECT REF (C) FROM tb_contrato C WHERE numero = 7170), (SELECT REF (F) FROM tb_funcionario F WHERE cpf = '35454794040'), (SELECT REF (B) FROM tb_bonificacao B WHERE id = 6)));
INSERT INTO tb_celebra VALUES (tp_celebra((SELECT REF (C) FROM tb_contrato C WHERE numero = 1464), (SELECT REF (F) FROM tb_funcionario F WHERE cpf = '99941481091'), (SELECT REF (B) FROM tb_bonificacao B WHERE id = 7)));
INSERT INTO tb_celebra VALUES (tp_celebra((SELECT REF (C) FROM tb_contrato C WHERE numero = 4282), (SELECT REF (F) FROM tb_funcionario F WHERE cpf = '99941481091'), (SELECT REF (B) FROM tb_bonificacao B WHERE id = 8)));

---------------------------------------------------------------------------------------------------- INSERTS ALUGA ----------------------------------------------------------------------------------------------------
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '3993258644'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '15069931091'), (SELECT REF(C) FROM tb_contrato WHERE numero = 3543), TO_DATE('01-11-2021', 'dd-mm-yyyy')))
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '6646303088'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '75477832010'), (SELECT REF(C) FROM tb_contrato WHERE numero = 8272), TO_DATE('01-09-2021', 'dd-mm-yyyy')))
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '3471019961'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '75477832010'), (SELECT REF(C) FROM tb_contrato WHERE numero = 6526), TO_DATE('07-06-2021', 'dd-mm-yyyy')))
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '8574634983'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '45851424010'), (SELECT REF(C) FROM tb_contrato WHERE numero = 2393), TO_DATE('01-05-2021', 'dd-mm-yyyy')))
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '8637564621'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '38120912080'), (SELECT REF(C) FROM tb_contrato WHERE numero = 5932), TO_DATE('01-02-2021', 'dd-mm-yyyy')))
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '4960932100'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '10217341012'), (SELECT REF(C) FROM tb_contrato WHERE numero = 5121), TO_DATE('01-09-2020', 'dd-mm-yyyy')))
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '9636810223'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '92027748032'), (SELECT REF(C) FROM tb_contrato WHERE numero = 2285), TO_DATE('08-09-2020', 'dd-mm-yyyy')))
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '4188415871'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '71033122068'), (SELECT REF(C) FROM tb_contrato WHERE numero = 8105), TO_DATE('01-12-2021', 'dd-mm-yyyy')))
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '2670703949'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '98643394009'), (SELECT REF(C) FROM tb_contrato WHERE numero = 8285), TO_DATE('01-12-2020', 'dd-mm-yyyy')))
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '2813137039'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '96458502079'), (SELECT REF(C) FROM tb_contrato WHERE numero = 7170), TO_DATE('01-11-2020', 'dd-mm-yyyy')))
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '5954115089'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '90019224060'), (SELECT REF(C) FROM tb_contrato WHERE numero = 1464), TO_DATE('05-12-2020', 'dd-mm-yyyy')))
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '7333288555'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '15069931091'), (SELECT REF(C) FROM tb_contrato WHERE numero = 6524), TO_DATE('10-01-2020', 'dd-mm-yyyy')))
INSERT INTO tb_aluga VALUES (tp_aluga((SELECT REF(I) FROM tb_imovel WHERE cod_escritura = '5504615237'), (SELECT REF(I) from tb_inquilino I WHERE cpf = '90019224060'), (SELECT REF(C) FROM tb_contrato WHERE numero = 4282), TO_DATE('01-09-2020', 'dd-mm-yyyy')))
